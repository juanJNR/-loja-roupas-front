...
export default function AdminLogin() {
  ...
  return (
    <main className="max-w-screen-xl flex flex-col items-center mx-auto p-6">
      <img src="../../blusa.png" alt="Loja" style={{ width: 240 }}
        className="d-block" />
      <div className="max-w-sm">
        <h1 className="text-3xl font-bold my-8">Admin: Loja de Roupas</h1>
        <form className="max-w-sm mx-auto"
          onSubmit={handleSubmit(verificaLogin)} >
          <div className="mb-5">
            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">E-mail:</label>
          ...
          <div className="mb-5">
            <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Senha:</label>
